...
val backGroundAlphaColor = Color(0x4D000000)
...
val artHorizontalGradientBackground = Brush.horizontalGradient(
    0.0f to artBackgroundColor,
    0.8f to Color(0xFFFFFFFF)
)
val danceHorizontalGradientBackground = Brush.horizontalGradient(
    0.0f to danceBackgroundColor,
    0.8f to Color(0xFFFFFFFF)
)
val musicHorizontalGradientBackground = Brush.horizontalGradient(
    0.0f to musicBackgroundColor,
    0.8f to Color(0xFFFFFFFF)
)
val theatreHorizontalGradientBackground = Brush.horizontalGradient(
    0.0f to theatreBackgroundColor,
    0.8f to Color(0xFFFFFFFF)
)
